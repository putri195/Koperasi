...
--
-- Host: localhost:3306
-- Waktu pembuatan: 05 Agu 2025 pada 01.35
-- Versi server: 5.7.39
-- Versi PHP: 8.2.29
...
CREATE TABLE `cash_book` (
  ...
  `description` text,
  `transaction_type` enum('Simpanan Pokok','Simpanan Wajib','Simpanan Sukarela','Pinjaman','Angsuran','Modal Awal','Bunga') NOT NULL,
