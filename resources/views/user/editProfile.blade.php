            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink">
                <li>
                    <a class="dropdown-item" href="{{ route('profil') }}">
                        <i class="bi bi-pencil-square me-2"></i>Profil
                    </a>
                </li>
                <li>
            ...
            <div class="card p-4 mx-auto">
                ...
                <form action="{{ route('user.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row form-section">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="first_name" value="{{ old('firstName', $firstName ?? '') }}" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Last Name:</label>
                                <input type="text" class="form-control" name="last_name" value="{{ old('lastName', $lastName ?? '') }}" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="gender" required>
                                    ...
                                    <option value="Laki-laki" {{ (isset($member) && $member->gender == 'Laki-laki') ? 'selected' : '' }}>Laki-laki</option>
                                    <option value="Perempuan" {{ (isset($member) && $member->gender == 'Perempuan') ? 'selected' : '' }}>Perempuan</option>
                                </select>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="address" rows="2" required>{{ old('address', $member->address ?? '') }}</textarea>
                            </div>
                        </div>
                    ...
                    <div class="d-flex gap-2 mt-3">
                        ...
                        <a href="{{ route('profil') }}" class="btn btn-batal px-4">Batal</a>
                    </div>
                </form>
            </div>
        </div>
