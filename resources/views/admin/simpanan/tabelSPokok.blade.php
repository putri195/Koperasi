...
<body>
    ...
    <div id="content">
        <div class="card p-4">
            <h4 class="fw-bold mb-4">Simpanan pokok</h4>

            <!-- Filter, Pencarian, dan Tombol Cetak -->
            <div class="row align-items-center mb-3">
                <div class="col-lg-10">
                    <form method="GET" action="{{ route('simpanan.pokok') }}" class="d-flex gap-2 flex-wrap">
                ...
                <div class="col-lg-2 text-lg-end mt-2 mt-lg-0">
                    <a href="{{ route('simpanan.pokok.export') }}" class="btn btn-cetak w-100 w-lg-auto">
                    ...
                    <tbody>
                        @foreach($data as $row)
                            <tr>
                                ...
                                <td>{{ number_format($row['ambil'], 0, ',', '.') }}</td>
